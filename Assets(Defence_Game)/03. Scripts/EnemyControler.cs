...
public class EnemyControler : MonoBehaviour
{
    ...
    [Range(0.0f, 10.0f)] public float speed = 5.0f;

    //거리에 따른 상태 체크 변수 
    [Tooltip("몬스터 발견거리!!!")]
    [Range(35.0f, 39.0f)] [SerializeField] float findDist = 37.5f;
    [Tooltip("몬스터 추적거리!!!")]
    [Range(30.0f, 34.0f)] [SerializeField] float traceDist = 32.5f;
    [Tooltip("몬스터 공격거리!!!")]
    [Range(5.0f, 20.0f)] [SerializeField] float attackDist = 7.0f;
    [Tooltip("몬스터 로밍 시간!!!")]
    [Range(30.0f, 50.0f)] [SerializeField] float hungryTimeSet = 40f;
    [Tooltip("몬스터 로밍 대기시간!!!")]
    [Range(30.0f, 50.0f)] [SerializeField] float nonHungryTimeSet = 40f;
...
#if UNITY_2017_3_1 || UNITY_5_3_2 || UNITY_2019_4_32
        Debug.Log("DDD");
#endif
